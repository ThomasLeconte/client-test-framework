...
public class StepsTest {
    ...
    public void jeDeclareUneNouvelleRéférenceDeTelephoneAvecLeNomEtLesDimensions(String ref, String dimensions) throws FileNotFoundException {
    ...
    @And("Je definis l'element {string} avec la référence {string}")
    public void jeDefinisLElementAvecLaRéférence(String ref, String xpath) {
